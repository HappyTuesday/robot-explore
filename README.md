...
- 223 个具体名词、9 关：1～3 关动物与水果，4～6 关食物、交通工具及日用品，7～9 关混合复习并优先复现错词。
...
- 插画制作规范见 `docs/ocean-illustrations.md`，223 个提示词见 `docs/ocean-image-prompts.jsonl`。图像 API 仅用于离线制作素材，游戏运行时不调用 API，也不包含密钥。
